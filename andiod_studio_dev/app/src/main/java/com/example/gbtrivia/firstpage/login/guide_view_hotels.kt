...
class guide_view_hotels : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_guide_view_hotels)
        val gig_button = findViewById<Button>(R.id.view_gigs_guide)
        gig_button.setOnClickListener {
            val intent = Intent(this@guide_view_hotels, traveller_view_gigs::class.java)
            startActivity(intent)
        }
        val place_button = findViewById<Button>(R.id.view_places_guide)
        place_button.setOnClickListener {
            val intent = Intent(this@guide_view_hotels, traveller_view_places::class.java)
            startActivity(intent)
        }
...
//        imageSlider.setImageList(imageList)
        ...
        chitral.setOnClickListener {
            val intent = Intent(this@guide_view_hotels, ChitralScreen::class.java)
            startActivity(intent)
        }
        val gilgit = findViewById<Button>(R.id.btnGilgit)
        gilgit.setOnClickListener {
            val intent = Intent(this@guide_view_hotels, GilgitScreen::class.java)
            startActivity(intent)
        }
        val hunza = findViewById<Button>(R.id.btnHunza)
        hunza.setOnClickListener {
            val intent = Intent(this@guide_view_hotels, HunzaScreen::class.java)
            startActivity(intent)
        }
        val skardu = findViewById<Button>(R.id.btnSkardu)
        skardu.setOnClickListener {
            val intent = Intent(this@guide_view_hotels, SkarduScreen::class.java)
            startActivity(intent)
        }
        val khaplu = findViewById<Button>(R.id.btnKhaplu)
        khaplu.setOnClickListener {
            val intent = Intent(this@guide_view_hotels, KhapluScreen::class.java)
            startActivity(intent)
        }
        val shangrila = findViewById<Button>(R.id.btnShangrila)
        shangrila.setOnClickListener {
            val intent = Intent(this@guide_view_hotels, ShangrilaScreen::class.java)
            startActivity(intent)
        }
        val baltit = findViewById<Button>(R.id.btnBaltit)
        baltit.setOnClickListener {
            val intent = Intent(this@guide_view_hotels, BaltitScreen::class.java)
            startActivity(intent)
        }
...
//            Toast.makeText(this, "Awesome", Toast.LENGTH_SHORT).show()
            val intent = Intent(this@guide_view_hotels, profile_guide::class.java)
            startActivity(intent);
        }
        else if (item?.itemId == R.id.Logout)
        {
//            Toast.makeText(this, "Logout", Toast.LENGTH_SHORT).show()
            val intent = Intent(this@guide_view_hotels, FirstPage::class.java)
            startActivity(intent);
        }
